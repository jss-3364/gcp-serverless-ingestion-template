...
2. **GCP API Services**: Enables required Google Cloud APIs for the project
...
### `providers.tf`
Configures the Terraform providers:
- Google Cloud Provider version `7.9.0`
...
- Lists GCP APIs to enable (compute and storage)
...
2. Proceed with deploying the main infrastructure
3. Configure backend state for other Terraform modules to use this bucket
